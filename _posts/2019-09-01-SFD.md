...
- [VAR Model Exploration](#var-model-exploration)
  ...
  * [Test For Stationarity](#tes-for-stationarity)
...
series sequence after we make sure the dataset is clean without any missing values.
...
<div style="text-align: justify"> The second differencing makes all sequences stationary as all P-values are less than 0.05, which rejects the null hypothesis.
